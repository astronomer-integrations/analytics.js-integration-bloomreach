...
.global('BrTrk')
.option('acctId', '')
.option('ignoreTrackProductCategoryUrl', '')
...
Bloomreach.prototype.viewedProduct = function (track) {
    ...
    if (this.options.ignoreTrackProductCategoryUrl.length > 0) {
        br_data.url = this.ignoreTrackProductCategoryUrl;
    }
...
Bloomreach.prototype.viewedProductCategory = function (track) {
    ...
    if (this.ignoreTrackProductCategoryUrl.length > 0) {
        br_data.url = this.ignoreTrackProductCategoryUrl;
    }
